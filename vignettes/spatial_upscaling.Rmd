...
Environmental spatial-cross validation performed considerably better than regular spacial cross-validation but worse than random cross validation. Also the performance variance between folds in environmental cross-validation was very low compared to spatial cross-validation, even though the fold size was highly variable in environmental cross-validation. In conclusion, environmental predictors are more suitable for clustering than spatial predictors.
